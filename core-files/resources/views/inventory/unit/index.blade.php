                ...
                @foreach($units as $k => $unit)
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            <button data-url="{{ route('delete-unit',['id' => $unit->id]) }}" class="btn btn-danger btn-xs flat btn-delete" data-toggle="modal" data-target="#delete-content-modal"><i class="fa fa-trash-o"></i>Delete</button>
                        </td>
                    </tr>
                @endforeach
                </tbody>
